...
var _get2 = __webpack_require__(29);
...
var _parseInt = __webpack_require__(165);
...
var _TableCellBlot = __webpack_require__(50);
...
var TableTrick = function () {
  ...
  (0, _createClass3.default)(TableTrick, null, [{
    ...
    key: 'getSelectedTd',
    value: function getSelectedTd(quill) {
    ...
    key: 'getContainingTable',
    value: function getContainingTable(td) {
      return td && td.parent && td.parent.parent;
    }
  }, {
    key: 'findTable',
    value: function findTable(quill) {
      var cell = TableTrick.getSelectedTd(quill);
      if (cell) {
    ...
    key: 'updateColumnNumbers',
    value: function updateColumnNumbers(quill) {
      var table = TableTrick.findTable(quill);
      var rows = table.domNode.querySelectorAll('tr');
      rows.forEach(function (row) {
        var cells = row.querySelectorAll('td');
        cells.forEach(function (cell, i) {
          return cell.setAttribute('column', i + 1);
        });
      });
    }
  }, {
    key: 'resetGridBorders',
    value: function resetGridBorders(table) {
      if (table) {
    ...
    key: 'getCell',
    value: function getCell(quill) {
      var range = quill.getSelection();
      if (range == null) return null;

      var _quill$getLine = quill.getLine(range.index),
          _quill$getLine2 = (0, _slicedToArray3.default)(_quill$getLine, 2),
      ...
      if (value.includes('newtable_')) {
        ...
        for (var ri = 0; ri < row_count; ri++) {
          ...
          for (var ci = 0; ci < col_count; ci++) {
            ...
            var colspan = 1;
            var color = 'white';
            var _value = table_id + '|' + row_id + '|' + cell_id + '|' + (ci + 1) + '|' + color + '|' + colspan;
        ...
        if (_td2) {
          ...
          var tdNodesInRow = (0, _from2.default)(currentRow.domNode.children);
          newRow.domNode.setAttribute('row_id', _row_id);
          tdNodesInRow.forEach(function (cell, i) {
            var cell_id = TableTrick.random_id();
        ...
        var firstElement = quill.getLeaf(_index2)[0].parent.parent;
        ...
        for (var i = 0; i < _length2 + 1; i++) {
          var _td3 = quill.getLeaf(_index2 + i)[0].parent.parent;
...
var _ContainBlot2 = __webpack_require__(30);
...
var TableCell = function (_ContainBlot) {
    ...
    (0, _createClass3.default)(TableCell, [{
        ...
        value: function formats() {
            // We don't inherit from FormatBlot
            return (0, _defineProperty3.default)({}, this.statics.blotName, this.domNode.getAttribute('table_id') + '|' + this.domNode.getAttribute('row_id') + '|' + this.domNode.getAttribute('cell_id') + '|' + this.domNode.getAttribute('column') + '|' + this.domNode.getAttribute('color') + '|' + this.domNode.getAttribute('colspan'));
        }
    }, {
        key: 'optimize',
...
var tableToolbar = [{ table: tableOptions }, { table: 'append-row' }, { table: 'delete-row' }, { table: 'append-col' }, { table: 'delete-col' }, { table: 'merge' }, { 'table-color': colors }, { 'table-border': ['border-grid', 'border-outline', 'border-none'] }];
...
var _TableTrick = __webpack_require__(31);
...
var Stack = __webpack_require__(198),
    ...
    baseFor = __webpack_require__(222),
    baseMergeDeep = __webpack_require__(224),
    isObject = __webpack_require__(8),
...
var _tableToolbar = __webpack_require__(73);
...
window.Quill = __webpack_require__(7);
var quillTable = __webpack_require__(125);
...
var defaultToolbar = [[].concat((0, _toConsumableArray3.default)(quillTable.tableToolbar)), ['bold', 'italic', 'underline', 'strike'], ['blockquote', 'code-block', 'image'], [{ 'list': 'ordered' }, { 'list': 'bullet' }], [{ 'indent': '-1' }, { 'indent': '+1' }], [{ 'header': [1, 2, 3, 4, 5, 6, false] }], [{ 'color': [] }, { 'background': [] }], [{ 'font': [] }], [{ 'align': [] }], ['clean']];
var Editor = new Quill(document.getElementById('quillContainer'), {
    modules: {
        toolbar: {
            container: defaultToolbar,
            handlers: {
                'table-border': function tableBorder() {}, //This seems to be needed to be overwritten by modules table-border handler
                'table-color': function tableColor() {} //This seems to be needed to be overwritten by modules table-border handler
            }
        },
        table: true,
        tableResize: true
...
var _quillDelta = __webpack_require__(126);
...
var _TableRowBlot = __webpack_require__(81);

var _TableRowBlot2 = _interopRequireDefault(_TableRowBlot);

var _TableBlot = __webpack_require__(177);

var _TableBlot2 = _interopRequireDefault(_TableBlot);

var _ContainBlot = __webpack_require__(30);
...
var _TableResize = __webpack_require__(180);
...
_quill2.default.register('modules/tableResize', _TableResize2.default);
...
module.exports = {
    ...
    TableResizeModule: _TableResize2.default,
    TableModule: TableModule,
    tableToolbar: _tableToolbar2.default
};
...
var equal = __webpack_require__(75);
var extend = __webpack_require__(76);
var op = __webpack_require__(130);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(40)(Function.call, __webpack_require__(55).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// module
exports.push([module.i, ".ql-editor table {\n    table-layout: fixed;\n    width: 100%;\n    border-collapse: collapse;\n}\n\n.ql-editor table td {\n    border: 1px solid black;\n    padding: 5px;\n    height: 25px;\n}\n\n.ql-formats button.ql-table::after,\n.ql-formats .ql-picker.ql-table .ql-picker-label::before {\n    content: \" \";\n    display: block;\n    width: 18px;\n    height: 18px;\n    background-repeat: no-repeat;\n    background-size: contain;\n}\n\n.ql-picker.ql-table .ql-picker-label {\n    background-image: url('data:image/png;base64,');\n    background-size: 20px 20px;\n    background-repeat: no-repeat;\n    background-position-y: 2px;\n}\n\nbutton.ql-table[value=\"append-row\"]::after {\n    background-image: url('data:image/png;base64,');\n}\n\nbutton.ql-table[value=\"append-col\"] {\n    padding-top: 0;\n}\n\nbutton.ql-table[value=\"append-col\"]::after {\n    background-image: url('data:image/png;base64,');\n}\n\n.ql-table,\n.ql-contain {\n    width: auto !important;\n    margin-right: 0;\n}\n\n.ql-picker.ql-table {\n    font-size: 11px;\n    font-weight: normal;\n}\n\n.ql-picker.ql-table svg {\n    display: none;\n}\n\n.ql-picker.ql-table .ql-picker-label {\n    padding: 2px 3px;\n}\n\n.ql-picker.ql-table .ql-picker-options {\n    width: 178px;\n}\n\n.ql-picker.ql-table .ql-picker-item {\n    display: block;\n    float: left;\n    width: 30px;\n    height: 30px;\n    line-height: 30px;\n    text-align: center;\n    padding: 0px;\n    margin: 1px;\n}\n\n.ql-picker.ql-table .ql-picker-item {\n    border: 1px solid #444;\n    color: #444;\n}\n\n.ql-picker.ql-table .ql-picker-item:hover {\n    border-color: #06c;\n}\n\n.ql-picker-item:nth-child(5):before {\n    clear: both;\n    display: block;\n    content: \"\";\n    width: 100%;\n}\n\n.ql-picker-item[data-value=newtable_1_1]:before {\n    content: \"1x1\";\n}\n\n.ql-picker-item[data-value=newtable_1_2]:before {\n    content: \"1x2\";\n}\n\n.ql-picker-item[data-value=newtable_1_3]:before {\n    content: \"1x3\";\n}\n\n.ql-picker-item[data-value=newtable_1_4]:before {\n    content: \"1x4\";\n}\n\n.ql-picker-item[data-value=newtable_1_5]:before {\n    content: \"1x5\";\n}\n\n.ql-picker-item[data-value=newtable_2_1]:before {\n    content: \"2x1\";\n}\n\n.ql-picker-item[data-value=newtable_2_2]:before {\n    content: \"2x2\";\n}\n\n.ql-picker-item[data-value=newtable_2_3]:before {\n    content: \"2x3\";\n}\n\n.ql-picker-item[data-value=newtable_2_4]:before {\n    content: \"2x4\";\n}\n\n.ql-picker-item[data-value=newtable_2_5]:before {\n    content: \"2x5\";\n}\n\n.ql-picker-item[data-value=newtable_3_1]:before {\n    content: \"3x1\";\n}\n\n.ql-picker-item[data-value=newtable_3_2]:before {\n    content: \"3x2\";\n}\n\n.ql-picker-item[data-value=newtable_3_3]:before {\n    content: \"3x3\";\n}\n\n.ql-picker-item[data-value=newtable_3_4]:before {\n    content: \"3x4\";\n}\n\n.ql-picker-item[data-value=newtable_3_5]:before {\n    content: \"3x5\";\n}\n\n.ql-picker-item[data-value=newtable_4_1]:before {\n    content: \"4x1\";\n}\n\n.ql-picker-item[data-value=newtable_4_2]:before {\n    content: \"4x2\";\n}\n\n.ql-picker-item[data-value=newtable_4_3]:before {\n    content: \"4x3\";\n}\n\n.ql-picker-item[data-value=newtable_4_4]:before {\n    content: \"4x4\";\n}\n\n.ql-picker-item[data-value=newtable_4_5]:before {\n    content: \"4x5\";\n}\n\n.ql-picker-item[data-value=newtable_5_1]:before {\n    content: \"5x1\";\n}\n\n.ql-picker-item[data-value=newtable_5_2]:before {\n    content: \"5x2\";\n}\n\n.ql-picker-item[data-value=newtable_5_3]:before {\n    content: \"5x3\";\n}\n\n.ql-picker-item[data-value=newtable_5_4]:before {\n    content: \"5x4\";\n}\n\n.ql-picker-item[data-value=newtable_5_5]:before {\n    content: \"5x5\";\n}\n\n.ql-picker-item[data-value=newtable_6_1]:before {\n    content: \"6x1\";\n}\n\n.ql-picker-item[data-value=newtable_6_2]:before {\n    content: \"6x2\";\n}\n\n.ql-picker-item[data-value=newtable_6_3]:before {\n    content: \"6x3\";\n}\n\n.ql-picker-item[data-value=newtable_6_4]:before {\n    content: \"6x4\";\n}\n\n.ql-picker-item[data-value=newtable_6_5]:before {\n    content: \"6x5\";\n}\n\n.ql-picker-item[data-value=newtable_7_1]:before {\n    content: \"7x1\";\n}\n\n.ql-picker-item[data-value=newtable_7_2]:before {\n    content: \"7x2\";\n}\n\n.ql-picker-item[data-value=newtable_7_3]:before {\n    content: \"7x3\";\n}\n\n.ql-picker-item[data-value=newtable_7_4]:before {\n    content: \"7x4\";\n}\n\n.ql-picker-item[data-value=newtable_7_5]:before {\n    content: \"7x5\";\n}\n\n.ql-picker-item[data-value=newtable_8_1]:before {\n    content: \"8x1\";\n}\n\n.ql-picker-item[data-value=newtable_8_2]:before {\n    content: \"8x2\";\n}\n\n.ql-picker-item[data-value=newtable_8_3]:before {\n    content: \"8x3\";\n}\n\n.ql-picker-item[data-value=newtable_8_4]:before {\n    content: \"8x4\";\n}\n\n.ql-picker-item[data-value=newtable_8_5]:before {\n    content: \"8x5\";\n}\n\n.ql-picker-item[data-value=newtable_9_1]:before {\n    content: \"9x1\";\n}\n\n.ql-picker-item[data-value=newtable_9_2]:before {\n    content: \"9x2\";\n}\n\n.ql-picker-item[data-value=newtable_9_3]:before {\n    content: \"9x3\";\n}\n\n.ql-picker-item[data-value=newtable_9_4]:before {\n    content: \"9x4\";\n}\n\n.ql-picker-item[data-value=newtable_9_5]:before {\n    content: \"9x5\";\n}\n\n.ql-picker-item[data-value=newtable_10_1]:before {\n    content: \"10x1\";\n}\n\n.ql-picker-item[data-value=newtable_10_2]:before {\n    content: \"10x2\";\n}\n\n.ql-picker-item[data-value=newtable_10_3]:before {\n    content: \"10x3\";\n}\n\n.ql-picker-item[data-value=newtable_10_4]:before {\n    content: \"10x4\";\n}\n\n.ql-picker-item[data-value=newtable_10_5]:before {\n    content: \"10x5\";\n}\n\nbutton.ql-table[value=\"delete-row\"] {\n    background: url('data:image/png;base64,');\n    background-size: 16px 16px;\n    background-position: 0px 4px;\n    background-repeat: no-repeat;\n}\n\nbutton.ql-table[value=\"delete-col\"] {\n    background: url('data:image/png;base64,');\n    background-size: 16px 16px;\n    background-position: 0px 3px;\n    background-repeat: no-repeat;\n}\n\n\n/* Table Border */\n\n.ql-table-border.ql-picker {\n    width: 40px;\n}\n\n.ql-table-border .ql-picker-item {\n    width: 20px;\n    height: 20px;\n    background-repeat: no-repeat;\n}\n\nspan.ql-table-border [data-value=\"border-outline\"] {\n    background-image: url('data:image/png;base64,');\n}\n\nspan.ql-table-border [data-value=\"border-none\"] {\n    background-image: url('data:image/png;base64,');\n}\n\nspan.ql-table-border [data-value=\"border-grid\"] {\n    background-image: url('data:image/png;base64,');\n}\n\n.ql-table-border .ql-picker-label svg {\n    left: 15px;\n}\n\n.ql-table-border .ql-picker-label {\n    width: 20px;\n    height: 20px;\n    background-repeat: no-repeat;\n    background-image: url('data:image/png;base64,');\n    background-size: 16px 16px;\n    background-position: 0px 2px;\n    background-repeat: no-repeat;\n}\n\ntable.table-border-none td {\n    border: none;\n}\n\ntable.table-border-outline {\n    border: 1px solid black;\n}\n\ntable.table-border-outline td {\n    border: none;\n}\n\nspan.ql-table-border span.ql-picker-item {\n    background-size: 18px;\n    background-repeat: no-repeat;\n}\n\n/* Table Background colors */\n\n.ql-table-color.ql-picker {\n    width: 25px;\n    margin-right: 20px;\n    padding: 3px 6px 3px 0\n}\n\n.ql-table-color .ql-picker-item {\n    width: 20px;\n    height: 20px;\n    background-repeat: no-repeat;\n}\n\n.ql-table-color .ql-picker-label {\n    background-color: yellow;\n}\n\n.ql-table-color .ql-picker-label svg {\n    left: 17px\n}\n\nspan.ql-table-color .ql-picker-options {\n    padding: 3px 5px;\n    width: 152px;\n}\n\nspan.ql-table-color .ql-picker-item {\n    border: 1px solid transparent;\n    float: left;\n    height: 16px;\n    margin: 2px;\n    padding: 0px;\n    width: 16px;\n}\n\nspan.ql-table-color .ql-picker-item[data-value='#000000'] {\n    background-color: #000000;\n}\nspan.ql-table-color .ql-picker-item[data-value='#e60000'] {\n    background-color: #e60000;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ff9900'] {\n    background-color: #ff9900;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ffff00'] {\n    background-color: #ffff00;\n}\nspan.ql-table-color .ql-picker-item[data-value='#008a00'] {\n    background-color: #008a00;\n}\nspan.ql-table-color .ql-picker-item[data-value='#0066cc'] {\n    background-color: #0066cc;\n}\nspan.ql-table-color .ql-picker-item[data-value='#9933ff'] {\n    background-color: #9933ff;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ffffff'] {\n    background-color: #ffffff;\n}\nspan.ql-table-color .ql-picker-item[data-value='#facccc'] {\n    background-color: #facccc;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ffebcc'] {\n    background-color: #ffebcc;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ffffcc'] {\n    background-color: #ffffcc;\n}\nspan.ql-table-color .ql-picker-item[data-value='#cce8cc'] {\n    background-color: #cce8cc;\n}\nspan.ql-table-color .ql-picker-item[data-value='#cce0f5'] {\n    background-color: #cce0f5;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ebd6ff'] {\n    background-color: #ebd6ff;\n}\nspan.ql-table-color .ql-picker-item[data-value='#bbbbbb'] {\n    background-color: #bbbbbb;\n}\nspan.ql-table-color .ql-picker-item[data-value='#f06666'] {\n    background-color: #f06666;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ffc266'] {\n    background-color: #ffc266;\n}\nspan.ql-table-color .ql-picker-item[data-value='#ffff66'] {\n    background-color: #ffff66;\n}\nspan.ql-table-color .ql-picker-item[data-value='#66b966'] {\n    background-color: #66b966;\n}\nspan.ql-table-color .ql-picker-item[data-value='#66a3e0'] {\n    background-color: #66a3e0;\n}\nspan.ql-table-color .ql-picker-item[data-value='#c285ff'] {\n    background-color: #c285ff;\n}\nspan.ql-table-color .ql-picker-item[data-value='#888888'] {\n    background-color: #888888;\n}\nspan.ql-table-color .ql-picker-item[data-value='#a10000'] {\n    background-color: #a10000;\n}\nspan.ql-table-color .ql-picker-item[data-value='#b26b00'] {\n    background-color: #b26b00;\n}\nspan.ql-table-color .ql-picker-item[data-value='#b2b200'] {\n    background-color: #b2b200;\n}\nspan.ql-table-color .ql-picker-item[data-value='#006100'] {\n    background-color: #006100;\n}\nspan.ql-table-color .ql-picker-item[data-value='#0047b2'] {\n    background-color: #0047b2;\n}\nspan.ql-table-color .ql-picker-item[data-value='#6b24b2'] {\n    background-color: #6b24b2;\n}\nspan.ql-table-color .ql-picker-item[data-value='#444444'] {\n    background-color: #444444;\n}\nspan.ql-table-color .ql-picker-item[data-value='#5c0000'] {\n    background-color: #5c0000;\n}\nspan.ql-table-color .ql-picker-item[data-value='#663d00'] {\n    background-color: #663d00;\n}\nspan.ql-table-color .ql-picker-item[data-value='#666600'] {\n    background-color: #666600;\n}\nspan.ql-table-color .ql-picker-item[data-value='#003700'] {\n    background-color: #003700;\n}\nspan.ql-table-color .ql-picker-item[data-value='#002966'] {\n    background-color: #002966;\n}\nspan.ql-table-color .ql-picker-item[data-value='#3d1466'] {\n    background-color: #3d1466;\n}\n\n.ql-table[value=merge]:after {\n    background-image: url(data:image/svg+xml;base64,);\n}\n", ""]);
...
var _defaultsDeep = __webpack_require__(184);

var _defaultsDeep2 = _interopRequireDefault(_defaultsDeep);

var _DefaultOptions = __webpack_require__(250);

var _DefaultOptions2 = _interopRequireDefault(_DefaultOptions);

var _Resize = __webpack_require__(251);

var _TableTrick = __webpack_require__(31);

var _TableTrick2 = _interopRequireDefault(_TableTrick);

var _TableAttributors = __webpack_require__(253);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var knownModules = { Resize: _Resize.Resize };
...
var TableResize = function TableResize(quill) {
    var _this = this;
    ...
    this.showOverlay = function () {
        ...
        document.addEventListener('keyup', _this.checkTable, true);
        _this.quill.root.addEventListener('input', _this.checkTable, true);

        // Create and add the overlay
        _this.overlay = document.createElement('div');
        (0, _assign2.default)(_this.overlay.style, _this.options.overlayStyles);
    ...
    this.hideOverlay = function () {
        ...
        document.removeEventListener('keyup', _this.checkTable);
        _this.quill.root.removeEventListener('input', _this.checkTable);
    ...
    this.checkTable = function (evt) {
        if (_this.table) {
            if (evt.keyCode == 46 || evt.keyCode == 8) {
                window.Quill.find(_this.table).deleteAt(0);
            }
            _this.hide();
        }
    };
    ...
    this.options = (0, _defaultsDeep2.default)({}, options, _DefaultOptions2.default);
...
if (window.Quill) {
    ...
    window.Quill.register('attributors/style/style', _TableAttributors.TableStyle);
}
...
var baseCreate = __webpack_require__(231),
...
var _BaseModule2 = __webpack_require__(252);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Resize = exports.Resize = function (_BaseModule) {
    (0, _inherits3.default)(Resize, _BaseModule);
    ...
    function Resize() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Resize.__proto__ || (0, _getPrototypeOf2.default)(Resize)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
            ...
            { left: handleXOffset, bottom: handleYOffset }].forEach(function (pos, idx) {
                (0, _assign2.default)(_this.boxes[idx].style, pos);
            });
            ...
            (0, _assign2.default)(box.style, _this.options.handleStyles);
            ...
            if (_this.dragBox === _this.boxes[0] || _this.dragBox === _this.boxes[3]) {
                ...
                _this.table.style.width = Math.round(parseInt(_this.preDragWidth) - deltaX) + 'px';
            } else {
            ...
            [document.body, _this.table].forEach(function (el) {
                if (el && el.style) {
...
var BaseModule = exports.BaseModule = function BaseModule(resizer) {
...
var TableStyle = new Parchment.Attributor.Style('style', 'width', {
